  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="relative overflow-hidden px-5 pb-16 pt-36">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(251,191,36,.16),transparent_32%),radial-gradient(circle_at_80%_0%,rgba(56,189,248,.12),transparent_30%)]" />
        <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
            ...
            <div className="mt-10 space-y-4">
              <div className="contact-row">
                ...
                <div>
                  ...
                  <p className="text-slate-600">+91 {company.phones.join(' / +91 ')}</p>
                </div>
              </div>
              <div className="contact-row">
                <FaEnvelope />
                <div>
                  ...
                  <a href={`mailto:${company.email}`} className="text-slate-600 hover:text-amber-600">{company.email}</a>
                </div>
              </div>
              <div className="contact-row">
                <FaMapMarkerAlt />
          ...
          <EnquiryForm
            ...
            subtitle="Share your travel details and our team will receive your enquiry by email."
